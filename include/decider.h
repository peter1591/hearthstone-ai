...
private:
	...
	void GoToNextProgress(std::vector<ProgressData> &progresses, GameEngine::Board && current_board, ProgressData const* stepping_progress, TreeNode const* stepping_node, const GameEngine::Board &next_board);
