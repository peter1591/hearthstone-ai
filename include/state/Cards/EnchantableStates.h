...
namespace state
{
	namespace Cards
	{
		...
		public:
			...
			{
				static_assert(kFieldChangeId == 12, "field changed");
			}
		...
		public:
			static constexpr int kFieldChangeId = 12; // Change this if any field is changed. This helps to see where you should also modify
