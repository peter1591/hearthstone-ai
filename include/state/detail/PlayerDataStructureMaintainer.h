...
namespace state {
	...
	namespace detail {
		...
		struct PlayerDataStructureMaintainer<TargetCardType, kCardZoneInvalid> {
			...
			static void Add(board::Board & board, Cards::Manager & cards_mgr, CardRef card_ref);
			static void Remove(board::Board & board, Cards::Manager & cards_mgr, CardRef card_ref);
		};
		...
		struct PlayerDataStructureMaintainer<kCardTypeMinion, kCardZonePlay> {
			...
			static void Add(board::Board & board, Cards::Manager & cards_mgr,CardRef card_ref, int pos);
			static void Remove(board::Board & board, Cards::Manager & cards_mgr,CardRef card_ref);
			static void ReplaceBy(board::Board & board, Cards::Manager & cards_mgr, CardRef card_ref, CardRef new_card_ref);
		};
		template <>
