...
namespace state {
	...
	namespace detail {
		...
		struct PlayerDataStructureMaintainer<TargetCardType, kCardZoneInvalid> {
			...
			static void Add(board::Board & board, Cards::Manager & cards_mgr, FlowContext & flow_context, CardRef card_ref, Cards::Card & card);
			static void Remove(board::Board & board, Cards::Manager & cards_mgr, FlowContext & flow_context, CardRef card_ref, Cards::Card & card);
		};
		...
		struct PlayerDataStructureMaintainer<kCardTypeMinion, kCardZonePlay> {
			...
			static void Add(board::Board & board, Cards::Manager & cards_mgr, FlowContext & flow_context, CardRef card_ref, Cards::Card & card, int pos);
			static void Remove(board::Board & board, Cards::Manager & cards_mgr, FlowContext & flow_context, CardRef card_ref, Cards::Card & card);
		};
		template <>
