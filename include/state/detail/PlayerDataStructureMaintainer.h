...
namespace state {
	...
	namespace detail {
		...
		struct PlayerDataStructureMaintainer<TargetCardType, kCardZoneInvalid> {
			...
			static void Add(board::Board & board, Cards::Manager & cards_mgr, FlowControl::Manipulate & manipulate, CardRef card_ref, Cards::Card & card);
			static void Remove(board::Board & board, Cards::Manager & cards_mgr, FlowControl::Manipulate & manipulate, CardRef card_ref, Cards::Card & card);
		};
		...
		struct PlayerDataStructureMaintainer<kCardTypeMinion, kCardZonePlay> {
			...
			static void Add(board::Board & board, Cards::Manager & cards_mgr, FlowControl::Manipulate & manipulate,CardRef card_ref, Cards::Card & card, int pos);
			static void Remove(board::Board & board, Cards::Manager & cards_mgr, FlowControl::Manipulate & manipulate,CardRef card_ref, Cards::Card & card);
