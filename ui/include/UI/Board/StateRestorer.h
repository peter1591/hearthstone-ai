...
namespace ui
{
	namespace board
	{
		...
		{
		public:
			StateRestorer(Board const& board, UnknownCardsSetsManager & first, UnknownCardsSetsManager & second) 
		...
		private:
			Board const& board_;
			UnknownCardsSetsManager & first_unknown_cards_mgr_;
			UnknownCardsSetsManager & second_unknown_cards_mgr_;
		};
	}
}