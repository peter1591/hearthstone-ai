...
static state::Cards::RawCard GetCard1(state::PlayerIdentifier player, int zone_pos)
{
	...
	c1.damaged = 0;
	c1.enchantable_states.player = player;
	c1.zone = state::kCardZoneHand;
	c1.enchantable_states.cost = 5;
	c1.enchantable_states.max_hp = 2;
	c1.enchantable_states.attack = 7;
	return c1;
}
...
static state::Cards::RawCard GetCard2(state::PlayerIdentifier player, int zone_pos)
{
	...
	c1.enchantable_states.player = player;
	c1.zone = state::kCardZoneHand;
	c1.enchantable_states.cost = 1;
	c1.enchantable_states.attack = 3;
	c1.enchantable_states.max_hp = 10;
	return c1;
}
